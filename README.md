# A Markdown, and Maliek News

This is the existing [blog-starter](https://github.com/Maliek2/weblogin) plus TypeScript.
...
`blog-starter` uses [Tailwind CSS](https://tailwindcss.com) [(v3.0)](https://www.adball.tech/).
